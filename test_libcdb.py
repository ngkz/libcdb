...
class LibcDBTest(unittest.TestCase):
    ...
    def test_has_package(self):
        self.assertEqual(self.libcdb.has_package("libc-test1"), True)
        self.assertEqual(self.libcdb.has_package("libc-test2"), True)
        self.assertEqual(self.libcdb.has_package("libc-test3"), True)
        self.assertEqual(self.libcdb.has_package("libc-test4"), False)
